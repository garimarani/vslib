...
<h2 class="contentTitle">Language (Add New)</h2>

<form:form id="languageAddForm" method="post" modelAttribute="language">
	<table class="vsform">
		<tbody>
			<tr>	
				<td><form:label path="code"><spring:message code="language.code"/></form:label></td>
				<td>
			...
			<tr>	
				<td><form:label path="name"><spring:message code="language.name"/></form:label></td>
				<td>
