...
<h2 class="contentTitle">Library - (List All)</h2>

<table class="dataTable">
	<thead>
		<tr>
			<th style="width: 200px;"><spring:message code="library.code"/></th>
			<th><spring:message code="library.name"/></th>
			<th style="width: 200px;"><spring:message code="address.city"/></th>
			<th width="110px">Select</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${listLibrary}" var="lb">
			<tr>
				<td>
					${lb.code}
				</td>
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!firstPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/setup/library/listAll"/>"><span
											class="ui-icon ui-icon-arrowthickstop-1-w"></span></a></li>

									<li class="ui-state-default ui-corner-all"
										title="To previous page."><a
										href="<c:url value="/setup/library/listAll/previous"/>"><span
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!lastPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/setup/library/listAll/next"/>"><span
											class="ui-icon ui-icon-arrowthick-1-e"></span></a></li>
									<li class="ui-state-default ui-corner-all"
										title="To last page."><a
										href="<c:url value="/setup/library/listAll/last"/>"><span
