...
<h2 class="contentTitle">Patron Category - (List All)</h2>

<table class="dataTable">
	<thead>
		<tr>
			<th style="width: 200px;"><spring:message code="patronCategory.code"/></th>
			<th><spring:message code="patronCategory.name"/></th>
			<th style="width: 200px;"><spring:message code="fineCategory"/></th>
			<th width="110px">Select</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${listPatronCategory}" var="lb">
			<tr>
				<td>
					${lb.code}
				</td>
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!firstPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/setup/patronCategory/listAll"/>"><span
											class="ui-icon ui-icon-arrowthickstop-1-w"></span></a></li>

									<li class="ui-state-default ui-corner-all"
										title="To previous page."><a
										href="<c:url value="/setup/patronCategory/listAll/previous"/>"><span
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!lastPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/setup/patronCategory/listAll/next"/>"><span
											class="ui-icon ui-icon-arrowthick-1-e"></span></a></li>
									<li class="ui-state-default ui-corner-all"
										title="To last page."><a
										href="<c:url value="/setup/patronCategory/listAll/last"/>"><span
