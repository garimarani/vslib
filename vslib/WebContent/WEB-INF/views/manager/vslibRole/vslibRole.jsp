...
<h2 class="contentTitle">Role (Add New)</h2>

<form:form id="vslibRoleAddForm" method="post" modelAttribute="vslibRole">
	<table class="vsform">
		<tbody>
			<tr>	
				<td><form:label path="code"><spring:message code="vslibRole.code"/></form:label></td>
				<td>
			...
			<tr>	
				<td><form:label path="name"><spring:message code="vslibRole.name"/></form:label></td>
				<td>
