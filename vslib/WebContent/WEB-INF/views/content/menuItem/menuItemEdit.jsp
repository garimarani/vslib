...
<h2 class="contentTitle">Menu Item (Edit Details)</h2>

<form:form id="menuItemEditForm" method="post" modelAttribute="menuItem">
	<form:hidden path="id"/>
	<table class="vsform">
		<tbody>
			<tr>	
			...
			<tr>	
				<td><form:label path="published"><spring:message code="published"/></form:label></td>
				<td>
