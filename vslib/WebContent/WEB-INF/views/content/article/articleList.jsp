...
<h2 class="contentTitle">Article - (List All)</h2>

<table class="dataTable">
	<thead>
		<tr>
			<th><spring:message code="article.title"/></th>
			<th style="width: 200px;"><spring:message code="articleCategory"/></th>
			<th style="width: 75px;"><spring:message code="article.published"/></th>
			<th style="width: 75px;"><spring:message code="article.homePage"/></th>
				...
				<td>
					<ul id="icons" class="ui-widget ui-helper-clearfix">
						<li class="ui-state-default ui-corner-all" title="Edit"><a
							href="<c:url value="/content/article/edit/${lb.id}"/>"><span
								class="ui-icon ui-icon-pencil"></span></a></li>
						<li class="ui-state-default ui-corner-all" title="Delete"><a
							href="<c:url value="/content/article/delete/${lb.id}"/>" onclick="return getConfirmation();"><span
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!firstPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/content/article/listAll"/>"><span
											class="ui-icon ui-icon-arrowthickstop-1-w"></span></a></li>

									<li class="ui-state-default ui-corner-all"
										title="To previous page."><a
										href="<c:url value="/content/article/listAll/previous"/>"><span
							...
							<ul id="icons" class="ui-widget ui-helper-clearfix">
								<c:if test="${!lastPage}">
									<li class="ui-state-default ui-corner-all"
										...
										href="<c:url value="/content/article/listAll/next"/>"><span
											class="ui-icon ui-icon-arrowthick-1-e"></span></a></li>
									<li class="ui-state-default ui-corner-all"
										title="To last page."><a
										href="<c:url value="/content/article/listAll/last"/>"><span
