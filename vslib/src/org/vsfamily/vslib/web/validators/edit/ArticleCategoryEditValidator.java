...
@Component
public class ArticleCategoryEditValidator extends VslibBaseValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (obj.getName()!=null){
			...
			if (articleCategory!=null && !obj.getId().equals(articleCategory.getId())){
