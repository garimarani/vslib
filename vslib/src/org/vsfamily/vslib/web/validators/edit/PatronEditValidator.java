...
/**
 * Validator used for validating patron object at the time of edition.
 */
@Component
public class PatronEditValidator extends VslibBaseValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (obj.getNumber()!=null){
			...
			if (patron!=null && !patron.getId().equals(obj.getId())){
		...
		if (obj.getEmail()!=null){
			if (!this.lengthRange(obj.getEmail(), 0, 255)){
				...
				if (obj.getEmail().length()>1 && !this.isEmail(obj.getEmail())){
		...
		if (obj.getAlternateEmail()!=null){
			if (!this.lengthRange(obj.getAlternateEmail(), 0, 255)){
				...
				if (obj.getAlternateEmail().length()>1 && !this.isEmail(obj.getAlternateEmail())){
		...
		if (obj.getPassword()!=null){
			if (!this.lengthRange(obj.getPassword(), 3, 255)){
				...
				ValidationUtils.rejectIfEmptyOrWhitespace(errors, "retypePassword", "required.patron.retypePassword");
