...
/**
 * Validator used for validating LibraryBranch object at the time of edition.
 */
@Component
public class LibraryBranchEditValidator extends VslibBaseValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (obj.getCode()!=null){
			if (!this.lengthRange(obj.getCode(), 1, 20)){
				...
				if (libraryBranch!=null && !libraryBranch.getId().equals(obj.getId())){
