...
@Controller
@RequestMapping("/setup/library/view")
public class LibraryViewController extends SetupBaseController {

	@Autowired
	VslibService vslibService;
	
	@RequestMapping(value="/{id}", method=RequestMethod.GET)
	public String viewLibrary(@PathVariable Long id, Model model,RedirectAttributes reat){
		...
		return "setup/library/libraryView";
	}
}